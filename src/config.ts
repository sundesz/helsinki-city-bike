...
switch (process.env.NODE_ENV) {
  case 'production':
    ...
    DB_URL = process.env.DATABASE_URL_PRODUCTION as string;
  ...
  case 'development':
    ...
    DB_URL = process.env.DATABASE_URL_DEVELOPMENT as string;
...
export { PORT, DB_NAME, DB_URL, DB_USER, DB_PASSWORD, DB_HOST, DB_DRIVER };
